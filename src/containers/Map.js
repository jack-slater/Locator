...
export class Map extends Component {
  constructor () {
    ...
    this.state = {
      ...
      distB: 'unknown',
      distC: 'unknown',
      markers: [{title: 'A', latlng: {latitude: 53.501633, longitude: -2.195970}, description: 'first marker'},
      {title: 'B', latlng: {latitude: 53.501456, longitude: -2.196674}, description: 'second marker'},
